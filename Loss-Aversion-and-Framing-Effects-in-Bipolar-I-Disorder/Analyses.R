...
Participants=read.csv("/Users/Kimmie/Dropbox/Papers/Bipolar patients/Data/Demographics_full.csv",stringsAsFactors=FALSE)
colnames(Participants)= c("ID","Group","Progress","Age","Caucasian","Gender","Education","income","employment","living","marital","children","SES")
Participants=Participants[2:86,c(1:12)]
...
Gigantor=read.csv("/Users/Kimmie/Dropbox/Papers/Bipolar patients/Data/Emotion Volatility Preferences and Economic Decisions in Bipolar - FINAL CU VERSION (GIGANTOR IRB)_January 12, 2017_17.14.csv")
Gigantor=Gigantor[3:40,c(1:13,16:28)]
Nerd=read.csv("/Users/Kimmie/Dropbox/Papers/Bipolar patients/Data/Emotion Volatility Preferences and Economic Decisions in Bipolar - FINAL CU VERSION (NERD IRB)_February 9, 2017_12.31.csv")
Nerd=Nerd[3:32,1:26,46]
Pabst=read.csv("/Users/Kimmie/Dropbox/Papers/Bipolar patients/Data/Emotion Volatility Preferences and Economic Decisions in Bipolar - FINAL CU VERSION (PABST IRB)_February 9, 2017_14.00.csv",stringsAsFactors=FALSE)
Pabst=Pabst[4:32,1:26,46]

DepressManic=read.csv('/Users/Kimmie/Dropbox/Papers/Bipolar patients/Data/Emotion Volatility Economic Decisions BD_MERGED_02.01.17_Scoring+AllEmoVolatilityMeasures+Recalculated+CurrEmo+EmoPref+CatchItemExclusion.csv',stringsAsFactors=FALSE)
...
# Some 'reject' gambles have been coded as 2, change to 0 for consistency.
...
# quite low loss avesion in overall sample
summary(Bipolar$LA)
sd(Bipolar$LA)
aggregate(Bipolar$LA, by=list(group=Bipolar$Group),mean)
aggregate(Bipolar$LA, by=list(group=Bipolar$Group),sd)

# Overall sample: is sig from 3 reject gambles? Which would be random behavior.
...
summary(Bipolar.nls$asrm_tot) #normal symptom scores
...
# After removing loss seekers, more in line with loss averse behavior
...
#OLS model without loss seekers --> Group not sig
...
AD1=Bipolar[,c(1,25,27,28,29,31,32,39,40,41,44)]
AD1$APQ='Q4'
colnames(AD1)[2]="Choice"

AD2=Bipolar[,c(1,26,27,28,29,31,32,39,40,41,44)]
AD2$APQ='Q5'
...
AD1.nls=Bipolar.nls[,c(1,25,27,28,29,31,32,39,40,41)]
AD1.nls$APQ='Q4'
colnames(AD1.nls)[2]="Choice"

AD2.nls=Bipolar.nls[,c(1,26,27,28,29,31,32,39,40,41)]
AD2.nls$APQ='Q5'
